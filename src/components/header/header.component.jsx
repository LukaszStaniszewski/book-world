        ...
        <header className="header">
            ...
            <aside className={`header__overlay ${this.state.active}`}>
                ...
                <div className={`header__overlay__categories-menu ${this.state.categoriesActive}`} onClick={this.handleClickOverlay}>
                    ...
                    <Link className="header__overlay__categories-menu--link" link-text="Kryminał, thriller" to='shop/criminal'>Kryminał, thriller</Link>
                    <Link className="header__overlay__categories-menu--link" link-text="Biografie, pamiętnik" to='shop/biography'>Biografie, pamiętnik</Link>
            ...
            <div className={`hover-dropdown-menu ${this.state.dropdownMenu}`} onMouseLeave={this.onMouseLeave}>
                ...
                <Link className="hover-dropdown-menu--link" link-text="Kryminał, thriller" to='shop/criminal'>Kryminał, thriller</Link>
                <Link className="hover-dropdown-menu--link" link-text="Biografie, pamiętnik" to='shop/biography'>Biografie, pamiętnik</Link>
